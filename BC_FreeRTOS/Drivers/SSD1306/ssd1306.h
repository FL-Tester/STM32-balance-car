#ifndef BC_FREERTOS_SSD1306_H
#define BC_FREERTOS_SSD1306_H

#endif //BC_FREERTOS_SSD1306_H
/*
 * ssd1306.h
 *
...
// @param : 0 - 128
// @param : 0 - 64
void ssd1306_white_pixel(uint8_t x, uint8_t y); //该函数的作用是在指定的位置画一个白色的点
...
// @param : 0 - 128
// @param : 0 - 64
void ssd1306_set_cursor(uint8_t x, uint8_t y); // 设置光标位置
void ssd1306_enter();
void ssd1306_space();
